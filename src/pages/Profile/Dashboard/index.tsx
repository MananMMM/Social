...
export function Profile() {
  let { account, setAccount } = useOutletContext<IContext>();
  ...
  return (
    <div className="gradient-custom-2" style={{ backgroundColor: "rgb(227, 220, 230)" }}>
            ...
            <MDBCard>
              ...
              >
                <div
                  ...
                  style={{ width: "150px" }}
                >
                  <input type="file" ref={photo} onChange={choosePhoto} />
